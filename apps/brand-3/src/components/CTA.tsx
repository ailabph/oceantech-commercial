    ...
    <section id="contact" className="relative overflow-hidden px-6 py-32">
      ...
      <div className="relative z-10 mx-auto flex max-w-2xl flex-col items-center text-center">
        ...
        <div className="mt-10 flex flex-col gap-4 sm:flex-row">
          <a
            href="#"
            className="rounded-sm bg-rust px-8 py-4 font-body font-medium text-cream transition-colors hover:bg-rust-dark"
          >
            Talk to the Crew
          </a>
          <a
            href="#"
            className="rounded-sm border-2 border-cream/50 px-8 py-4 font-body font-medium text-cream transition-colors hover:border-cream hover:bg-cream/10"
          >
